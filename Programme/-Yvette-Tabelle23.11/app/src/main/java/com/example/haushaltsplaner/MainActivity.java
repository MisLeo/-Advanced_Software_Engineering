...
public class MainActivity extends AppCompatActivity {
    ...
    private void setData()
    {
        ...
        //float Ausgaben =outgoDB.getValuesOutgosCategory(1,11,2021,  "Sonstiges");
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        ...
        switch (item.getItemId()){
            ...
            case R.id.item6:
                //Erstellung Intent mit Empfänger, hier Tabelle Klasse
                Intent switchActivityIntent6 = new Intent(this, Tabelle.class);
                // If data is need to be sent between activities
                //      EditText editText = (EditText) findViewById(R.id.editTextTextPersonName);
                //      String message = editText.getText().toString();
                //      intent.putExtra(EXTRA_MESSAGE, message);
                //Rufe Activity "Tabelle" auf
